...
/**
   ...
   */
    ...
    /*Некликабельное лого на главной*/
    $('.header-main .header-logo a').on('click',function(e){
        e.preventDefault();
    });
    ...
    /*Фильтр брендов*/
    $('.js-charFilter').on('click',function(e){
        var char = $(this).data('value');
        $('.js-charFilter').removeClass('active');
        if(char == 'all'){
            $('.js-brandPanel').removeClass('hidden');
        }
        else{
            $(this).addClass('active');
            $('.js-brandPanel').addClass('hidden');
            $('[data-brandPanel='+ char +']').removeClass('hidden');
        }
        return false;
    });
    ...
    */
    ...
    $(document).delegate('.js-reviews-more', 'click', function(){
        ...
        modal.find('.reviews-block').html(content);
        modal.modal('show');
        return false;
    });
    ...
    */
    ...
    if($('div').hasClass('carouselSlider')){
        ...
        mainSlide.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            $('.counter').html(('0'+i) + '<sup> / ' + ('0'+slick.slideCount).slice(-2) + '</sup>');
        });
        mainSlide.slick({
            fade: true,
            infinite: true,
    ...
    /*Портфолио*/
    if($('div').hasClass('portfolio-slider')){
        $('.portfolio-slider').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.portfolio-arrows .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    /*Порфтолио case*/
    if($('div').hasClass('portfolio-case-carousel')){
        $('.portfolio-case-carousel').slick({
            fade: false,
            infinite: false,
            slidesToShow: 3,
            slidesToScroll: 1,
            ...
            arrows: true,
            dots: false,
            appendArrows: '.portfolio-case .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    if($('div').hasClass('reasons-block')){
        $('.reasons-block').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.reasons-arrows .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    if($('div').hasClass('clients-slider')){
        $('.clients-slider').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.clients-arrow .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    if($('div').hasClass('reviews-block')){
        $('.reviews-block').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.reviews-arrows .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    if($('div').hasClass('post-carousel')){
        $('.post-carousel').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.post-read-all .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
