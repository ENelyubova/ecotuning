...
<h1 style="font-weight:normal;">
    Здравствуйте!<br>
    Вы сделали заказ на сайте "<?= Yii::app()->getModule('yupe')->siteName;?>" на сумму <?= $order->getTotalPriceWithDelivery();?> <?= $currency ?>
</h1>
...
<h1 style="font-weight:normal;">Состав вашего заказа:</h1>
...
<p>
    Если вы хотите внести изменения в свой заказ или отменить его, напишите нам письмо на почту <?php $this->widget('application.modules.contentblock.widgets.ContentBlockWidget', ['code'=>'email']); ?> с указанием номера заказа
</p>
