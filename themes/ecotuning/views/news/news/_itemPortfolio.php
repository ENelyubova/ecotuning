<div class="portfolio-block__item js-portfolio-item">
    <div class="portfolio-item fl fl-w fl-jc-sb">
        <div class="portfolio-item__text fl fl-d-c">
            <div class="portfolio-item__title"><?= $data->title; ?></div>
            ...
            <div class="portfolio-item__btn fl fl-w fl-ai-c">
                <a href="<?= Yii::app()->createUrl('/news/news/viewPortfolio', ['slug' => $data->slug]); ?>" class="btn btn-green">Подробнее</a>
            </div>
        </div>
        <div class="portfolio-item__img">
            <a href="<?= Yii::app()->createUrl('/news/news/viewPortfolio', ['slug' => $data->slug]); ?>">
                <picture class="absolute-img-picture">
                    ...
                    <source media="(min-width: 1px)" srcset="<?= $data->getImageUrlWebp(360, 160, true, null,'image'); ?>" type="image/webp">
                    <source media="(min-width: 1px)" srcset="<?= $data->getImageNewUrl(360, 160, true, null,'image'); ?>">
