...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['title, title_short, slug, body, body_short, meta_title, meta_description, meta_keywords', 'filter', 'filter' => 'trim'],
            ['title, title_short, body_short, slug, meta_title, meta_description, meta_keywords', 'filter', 'filter' => [new YPurifier(), 'purify']],
            ...
            ['image, icon, body_short, character, shema, sertificate, delivery, price, documen', 'safe'],
            [
                'lang, id, parent_id, create_time, update_time, title, title_short, slug, body, body_short, meta_title, meta_keywords, meta_description, status, order, lang',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'icon' => Yii::t('PageModule.page', 'Фото1'),
