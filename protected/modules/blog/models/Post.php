...
class Post extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            ...
            [
                'blog_id, create_user_id, update_user_id, status, comment_status, access_type, create_time, update_time, category_id, visit',
                'numerical',
                'integerOnly' => true,
            ],
            [
                'blog_id, create_user_id, update_user_id, create_time, update_time, status, comment_status, access_type, visit',
                'length',
                'max' => 11,
            ],
            ['lang', 'length', 'max' => 2],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'quote' => Yii::t('BlogModule.blog', 'Короткое описание'),
            ...
            'visit' => Yii::t('BlogModule.blog', 'Просмотры'),
        ];
    }
    ...
    public function search($limit = null)
    {
        ...
        $criteria->compare('t.visit', $this->visit, true);
