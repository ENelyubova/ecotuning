...
class Blog extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['name, slug, description, body_short', 'filter', 'filter' => [new YPurifier(), 'purify']],
            ['slug', 'unique'],
            [
                'id, name, description, slug, type, status, create_user_id, update_user_id, create_time, update_time, lang, category_id, body_short',
                'safe',
                'on' => 'search'
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'body_short' => Yii::t('BlogModule.blog', 'Короткое описание'),
    ...
    public function search()
    {
        ...
        $criteria->compare('t.body_short', $this->body_short, true);
