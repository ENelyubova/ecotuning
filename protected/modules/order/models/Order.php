...
class Order extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['status_id', 'required'],
            ['name, phone, email', 'required', 'on' => self::SCENARIO_USER],
            ['email', 'email'],
            [
            ...
            ['url', 'unique'],
            [
                'user_id, paid, payment_time, payment_details, total_price, discount, coupon_discount, separate_delivery, status_id, date, ip, url, modified, verify',
                'unsafe',
