...
class StoreModule extends WebModule
{
    ...
    public $metaTitleTemplate;
    public $metaDescriptionTemplate;
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'course' => Yii::t('StoreModule.store', 'Курс'),
            'metaTitleTemplate' => Yii::t('StoreModule.store', 'Шаблон meta-title'),
            'metaDescriptionTemplate' => Yii::t('StoreModule.store', 'Шаблон meta-description'),
        ];
    }
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'url' => ['/store/productBackend/upload'],
                    ],
                ],
            ],
            [
