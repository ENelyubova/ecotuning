    ...
    <div class="tab-pane active" id="common">
        ...
        <div class='row'>
            <div class="col-sm-7">
                <?php
                echo CHtml::image(
                    !$model->isNewRecord && $model->img_bg ? $model->getImageNewUrl(200, 120, true, null,'img_bg') : '#',
                    '',
                    [
                        'class' => 'preview-image',
                        'style' => !$model->isNewRecord && $model->img_bg ? '' : 'display:none',
                    ]
                ); ?>

                <?php if (!$model->isNewRecord && $model->img_bg): ?>
                    <div class="checkbox">
                        <label>
                ...
                <?= $form->fileFieldGroup($model, 'img_bg'); ?>
