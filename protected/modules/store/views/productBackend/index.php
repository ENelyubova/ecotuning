...
<?php $this->widget(
    ...
    [
        ...
        'actionsButtons' => [
            'course' => CHtml::link(
                Yii::t('StoreModule.store', 'Обновить <i class="fa fa-euro"></i>'),
                ['/store/productBackend/course'],
                ['class' => 'btn btn-sm btn-success pull-right', 'style' => 'margin-left: 7px;']
            ),
            'add' => CHtml::link(
        ...
        'columns' => [
            ...
            [
                'class' => 'bootstrap.widgets.TbEditableColumn',
                'header' => 'Цена <i class="fa fa-euro"></i>',
                'name' => 'price_euro',
                'value' => function (Product $data) {
                    return round($data->price_euro, 3);
                },
                'editable' => [
                    'url' => $this->createUrl('/store/productBackend/inline'),
                    'mode' => 'inline',
                ...
                'filter' => CHtml::activeTextField($model, 'price_euro', ['class' => 'form-control']),
            ],
            [
                'class' => 'bootstrap.widgets.TbEditableColumn',
                'name' => 'price',
