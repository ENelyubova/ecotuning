...
class News extends yupe\models\YModel
{
    ...
    {
        return [
            ['title, name_model, slug, price, short_text, full_text, meta_title, meta_keywords, meta_description', 'filter', 'filter' => 'trim'],
            ...
            [
                'id, meta_title, meta_keywords, meta_description, create_time, update_time, date, title, name_model, slug, price, short_text, full_text, user_id, status, is_protected, lang',
                'safe',
                'on' => 'search'
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'price' => Yii::t('NewsModule.news', 'Цена'),
            'name_model' => Yii::t('NewsModule.news', 'Название модели'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('name_model', $this->name_model);
