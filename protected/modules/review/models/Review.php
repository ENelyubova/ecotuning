...
class Review extends yupe\models\YModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, date_created, username, text, moderation, useremail, image, position, product_id, rating, name_desc, body_tech', 'safe', 'on'=>'search'),
			/* array('image', 'file', 
                'types'=>'jpg, jpeg, png',
                'allowEmpty'=>true, 
            ),*/
			array('image, moderation, validate, category_id, position, date_created, product_id, countImage, name_desc, body_tech', 'safe'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('body_tech',$this->body_tech);
